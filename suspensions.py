...
# upcoming season. This can't be derived from historical stats as it's
...
SUSPENSIONS = {
    ...
    # NOTE: not a fixed-length suspension, rather placed on the Commissioner's
    ...
    # develops. As a result, this is the least reliable entry in this file.
    'Josh Jacobs': 10,
}
